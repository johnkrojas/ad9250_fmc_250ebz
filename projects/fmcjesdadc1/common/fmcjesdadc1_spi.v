...
module fmcjesdadc1_spi (
  ...
  assign spi_enable_s = spi_enable & ~spi_csn_i;
  assign spi_clk_o = spi_clk_i & ~spi_csn_o;

  always @(posedge spi_clk_i or posedge spi_csn_i) begin
    if (spi_csn_i == 1'b1) begin
      spi_count <= 6'd0;
      spi_devid <= 8'd0;
      spi_rd_wr_n <= 1'd0;
      spi_csn_reg <= 1'b1;
  ...
  always @(negedge spi_clk_i or posedge spi_csn_i) begin
    if (spi_csn_i == 1'b1) begin
        spi_csn_o <= 1'b1;
    end else begin
