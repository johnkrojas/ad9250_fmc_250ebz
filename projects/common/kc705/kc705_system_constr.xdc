...
#set_property -dict  {PACKAGE_PIN  G8 IOSTANDARD  DIFF_SSTL15} [get_ports sgmii_clk_p]
#set_property -dict  {PACKAGE_PIN  G7 IOSTANDARD  DIFF_SSTL15} [get_ports sgmii_clk_n]
